...
<body>
<div class="contan">
<a class="mina" href="logout.php">log out</a>
<div class="head">
<div class="lefthead">
...
<div class="righthead">
	...
	if (isset($_SESSION["full_name"]) and isset($_SESSION["username"])) {
		$count = 1;
	echo "<p class=\"pyqt\">".$_SESSION["full_name"]. " " .$_SESSION["username"]."</p>";
	}

	if($count == 0){
		echo '<script>
		var x = document.getElementsByClassName("mina");
	...
	?>
	<form action="data.php" align="center" method="POST">
