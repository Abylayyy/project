...
<div class="head">
<div class="lefthead">
<a href="index.php"><img src="lib.jpg" style="width:300px;height:70px;margin-top:5px;"></a>
</div>
<div class="righthead">
...
if (isset($_POST['sign'])) {
	...
	?>
<form action="home1.php" align="center" method="POST">
...
<div class="major">
  <center style="font-family: Arial, sans-serif;">
				<h3 style="color:blue;margin-top:20px;">Gallery of the best libraries</h3><br>
		<div class="example">
				<div id="slider">
						<img src="images/liberty.jpg" title="image" />
						<img src="images/best.jpg" title="image" />
						<img src="images/best1.jpg" title="image" />
						<img src="images/best2.jpg" title="image" />
						<img src="images/best3.jpg" title="image" />
						<img src="images/best4.jpg" title="image" />
						<img src="images/best5.jpg" title="image" />
						<img src="images/best6.jpg" title="image" />
						<img src="images/best7.jpg" title="image" />
						<img src="images/best8.jpg" title="image" />
				</div>
		</div>
  </center>
</div>
